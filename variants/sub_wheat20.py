...
LADDER TEST A -- wheat 20.
The 804-rated build sells 184 wheat a game to our 44 and zones 20 tiles
of it; we zone 6. Local ghost scoring says wheat 20 is worse (6/18
against 11/18) and local scoring has now disagreed with the ladder seven
times. Strawberry gives up the 14 tiles.
"""
import math
import os
...
STRAWBERRY_TILES = _P("STRAWBERRY_TILES", 26)
