...
LADDER TEST C -- the 804 build's herd.
It runs 13 cows to our 6 and sells 273 milk to our 146. Local sweeps put
the optimum at 6-8 cows every time they were run, against `starter` and
against ghosts, and both instruments have been wrong before.
"""
import math
import os
