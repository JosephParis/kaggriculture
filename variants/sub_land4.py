...
LADDER TEST B -- the fourth quadrant.
Banks +$4,397 over 12 paired seeds and loses the mirror 0-24, which is
the exact disagreement the ladder exists to settle. Never ladder-tested;
the only evidence against it is a mirror, and a mirror is not the field.
"""
import math
import os
